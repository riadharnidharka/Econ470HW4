...
#| echo: false
#| label: summary
#| tbl-cap: "Plan Characteristics"

library(kableExtra)
options(knitr.kable.NA = 0)
knitr::kable(question9, 
             col.names=c("plan_type", "partd", "rounded", "count"),
             format.args=list(big.mark=","), booktabs = TRUE) %>%
  kable_styling(latex_options=c("scale_down"))
...
#| echo: false
#| label: summary2
#| tbl-cap: "Plan Characteristics 3.5"

library(kableExtra)
options(knitr.kable.NA = 0)
knitr::kable(question9.2, 
             col.names=c("plan_type", "partd", "rounded", "count"),
             format.args=list(big.mark=","), booktabs = TRUE) %>%
  kable_styling(latex_options=c("scale_down"))
...
While there are the most plans in the middle section of star ratings, increasing a star rating increases enrollments. 
